...
RegisterNetEvent("ucrp-casino:blackjack:requestSitAtBlackjackTable")
AddEventHandler("ucrp-casino:blackjack:requestSitAtBlackjackTable", function(chairId)
    local source = source
    ...
    if source ~= nil then
        ...
        TriggerClientEvent("ucrp-casino:blackjack:sitAtBlackjackTable",source,chairId)
    else
...
RegisterNetEvent("ucrp-casino:blackjack:leaveBlackjackTable")
AddEventHandler("ucrp-casino:blackjack:leaveBlackjackTable", function(chairId)
    local source = source
...
RegisterNetEvent("ucrp-casino:blackjack:setBlackjackBet")
AddEventHandler("ucrp-casino:blackjack:setBlackjackBet",function(gameId,betAmount,chairId)
    local source = source
...
RegisterNetEvent("ucrp-casino:blackjack:hitBlackjack")
AddEventHandler("ucrp-casino:blackjack:hitBlackjack",function(gameId,nextCardCount)
    local source = source
    blackjackGameData[gameId][source][2][nextCardCount] = true
end)

RegisterNetEvent("ucrp-casino:blackjack:standBlackjack")
AddEventHandler("ucrp-casino:blackjack:standBlackjack",function(gameId,nextCardCount)
    local source = source
