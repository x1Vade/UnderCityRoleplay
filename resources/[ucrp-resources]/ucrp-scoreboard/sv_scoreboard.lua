...
RegisterServerEvent('ucrp-scoreboard:AddPlayer')
AddEventHandler("ucrp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("ucrp-scoreboard:AddPlayer", -1, data )
...
function NPX.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("ucrp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("ucrp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("ucrp-scoreboard:RemoveRecent", -1, plyid)
end)
