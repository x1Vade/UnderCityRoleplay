...
RegisterNetEvent("ucrp-scoreboard:RemovePlayer")
AddEventHandler("ucrp-scoreboard:RemovePlayer", function(data)
    NPX.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("ucrp-scoreboard:AddPlayer")
AddEventHandler("ucrp-scoreboard:AddPlayer", function(data)
    NPX.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("ucrp-scoreboard:RemoveRecent")
AddEventHandler("ucrp-scoreboard:RemoveRecent", function(src)
    NPX.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("ucrp-scoreboard:AddAllPlayers")
AddEventHandler("ucrp-scoreboard:AddAllPlayers", function(data)
