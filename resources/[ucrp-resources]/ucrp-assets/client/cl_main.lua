...
--         SetDiscordRichPresenceAction(0, 'Click To Play', 'Soon!')
--     end
-- end)

-- Citizen.CreateThread(function()
--     TriggerServerEvent('rich:GetPlayers')
--     SetDiscordAppId(tonumber(GetConvar("RichAppId", "BlackList Beta Server")))
--     SetDiscordRichPresenceAsset(GetConvar("RichAssetId", "BlackList Beta Server"))
--     while true do
--         Citizen.Wait(2000)
--         SetDiscordRichPresenceAssetText("Soon")
