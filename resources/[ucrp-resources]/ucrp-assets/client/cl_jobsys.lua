...
AddEventHandler('jobssystem:current', function(cb)
  LocalPlayer = exports["ucrp-base"]:getModule("LocalPlayer")
  cb(LocalPlayer:getVar("job"))
end)

local PaycheckSpot, called = false, false

exports["ucrp-polyzone"]:AddBoxZone("paycheck_collect", vector3(241.63, 226.48, 106.29), 4, 4, {
  heading=0
})
  ...
  Citizen.CreateThread(function()
    while PaycheckSpot do
      ...
      if IsControlJustReleased(0, 38) then
        local finished = exports["ucrp-taskbar"]:taskBar(2000,"Collecting Your Paycheck")
