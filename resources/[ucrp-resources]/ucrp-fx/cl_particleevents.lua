...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("ucrp-fx:setSteamId")
end)
RegisterNetEvent("ucrp-fix:setSteamIdClient")
AddEventHandler("ucrp-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["ucrp-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
