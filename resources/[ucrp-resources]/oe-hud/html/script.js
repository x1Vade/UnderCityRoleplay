...
window.addEventListener('message', function(event){
    ...
    if (data.action == "update") {
        ...
        if (data.parachute) {
            $("#parachutemode").fadeIn(500, function() { $("#parachutemode").css("display", "flex"); });
        } else if (data.parachute == false) {
            $("#parachutemode").fadeOut(500, function() { $("#parachutemode").css("display", "none"); });
        }
...
document.onkeyup = function (data) {
    if ( data.which == 27 ) { //esc
      $.post('https://oe-hud/close', JSON.stringify({}));
      $(".menu").fadeOut(500);
    }
};
...
$(function(){
    ...
    $(".defaultmap").change(function() {
        if ($('.defaultmap').prop('checked')) {
            $.post('https://oe-hud/minimap', JSON.stringify({
                action: "default"
            }));
        } else {
            $.post('https://oe-hud/minimap', JSON.stringify({
...
document.body.addEventListener('click', function(e) {
    ...
    $('.speedmeter-15').click(function(){
        ...
        $.post('https://oe-hud/carhud', JSON.stringify({
            fps: 500
        }));
    });
    ...
    $('.compass-15').click(function(){
        ...
        $.post('https://oe-hud/compass', JSON.stringify({
            fps: 750
        }));
    });
