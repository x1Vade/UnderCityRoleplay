...
Citizen.CreateThread(function()
	...
	-- Register Keybinds
	exports["ucrp-keybinds"]:registerKeyMapping("", "Weapons", "Switch Weapon Mode", "+switchWeaponMode", "-switchWeaponMode")
...
function SwitchWeaponMode()
	...
	if ForceWeaponMode[pWeaponHash] ~= nil then
		if SELECTED_FIRE_RATE == ForceWeaponMode[pWeaponHash] then
			...
			TriggerEvent("ucrp-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
		end
		return
	end
...
RegisterNetEvent("ucrp-weapons:client:weaponEquiped")
AddEventHandler("ucrp-weapons:client:weaponEquiped", function(pWeaponHash, newInformation, sqlID, itemToRemove, pArmed)
	if ForceWeaponMode[pWeaponHash] ~= nil then
		SELECTED_FIRE_RATE = ForceWeaponMode[pWeaponHash]
		TriggerEvent("ucrp-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
	end
	...
	TriggerEvent("ucrp-weapons:client:showWeaponFireRate", pArmed)
	TriggerEvent("ucrp-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
end)
