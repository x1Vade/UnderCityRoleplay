...
RegisterNetEvent("ucrp-editor:buildName")
AddEventHandler("ucrp-editor:buildName", function(name,objects, offsets)
    if objects then
...
RegisterNetEvent("ucrp-editor:destroyName")
AddEventHandler("ucrp-editor:destroyName", function(name)
    cleanUpArea(name)
