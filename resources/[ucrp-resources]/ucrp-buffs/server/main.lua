...
local function Removebuff(citizenID, buffName)
    ...
    if playerBuffs[citizenID] and playerBuffs[citizenID][buffName] then
        ...
        local player = NPBASE.Functions.GetPlayerByCitizenId(citizenID)
        local sourceID = nil
...
NPBASE.Functions.CreateCallback('buffs:server:fetchBuffs', function(source, cb)
    local player = NPBASE.Functions.GetPlayer(source)
    local citizenID = player.PlayerData.citizenid
    cb(playerBuffs[citizenID])
end)

NPBASE.Functions.CreateCallback('buffs:server:addBuff', function(source, cb, buffName, time)
    local player = NPBASE.Functions.GetPlayer(source)
    local citizenID = player.PlayerData.citizenid
