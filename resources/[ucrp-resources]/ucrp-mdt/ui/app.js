...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://ucrp-mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://ucrp-mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://ucrp-mdt/deleteBulletin', JSON.stringify({
            id: BulletinId
        }));
        ...
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                setTimeout(() => {
                    ...
                    $.post('https://ucrp-mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
    ...
    $(".manage-profile-save").click(function () {
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://ucrp-mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-save", function () {
        if (canSaveProfile == true) {
            ...
            $.post('https://ucrp-mdt/saveIncident', JSON.stringify({
                ID: dbid,
                title: title,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://ucrp-mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
       ...
       setTimeout(() => {
           ...
           setTimeout(() => {
               ...
               $.post('https://ucrp-mdt/searchVehicles', JSON.stringify({
                   name: plate.toString()
               }));
               $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
               setTimeout(() => {
                   $.post('https://ucrp-mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".revoke-licence", function () {
        if ($(this).data("status") != "red") {
            $.post('https://ucrp-mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://ucrp-mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://ucrp-mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://ucrp-mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://ucrp-mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".sm-items").on("click", ".sm-item", function () {
        $.post('https://ucrp-mdt/getStaffData', JSON.stringify({
            id: $(this).data("id")
        }));
    });
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://ucrp-mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://ucrp-mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        ...
        $.post('https://ucrp-mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://ucrp-mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://ucrp-mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://ucrp-mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () { 
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'img/ems_badge.png') {
                ...
                $.post('https://ucrp-mdt/deleteICU', JSON.stringify({
                id: $(this).data("info")
            }));
        }
        $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
        $.post('https://ucrp-mdt/deleteBolo', JSON.stringify({
            id: $(this).data("info")
        }));
        }
    ...
    $(".contextmenu").on("click", ".add-charge", function () { 
        ...
        $.post('https://ucrp-mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () { 
        ...
        if (incidentId != 0) {
            $.post('https://ucrp-mdt/removeIncidentCriminal', JSON.stringify({
    ...
    $(".icidents-person-search-holder").on("click", ".icidents-person-search-item", function () {
        ...
        $(".incidents-ghost-holder").prepend(
            ...
            `
        );  /*  <button class="manage-sentence-button" type="button" onclick="sendjail()" id="button-jail">Jail</button> */
    });
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () { 
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://ucrp-mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://ucrp-mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function(){
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://ucrp-mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://ucrp-mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://ucrp-mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        ...
        $.post('https://ucrp-mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $(".staff-information-title-holder").on("click", ".staff-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://ucrp-mdt/saveStaffInfo', JSON.stringify({
                    dbid: dbid,
                    callsign: callsign,
                    dept: dept,
                    rank: rank,
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://ucrp-mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () { 
        ...
        if ( tag.hasClass("red-tag")) {
            ...
            $.post('https://ucrp-mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".toggle-duty", function () { 
        ...
        if (currentStatus == "10-8") {
            ...
            $.post('https://ucrp-mdt/toggleDuty', JSON.stringify({
                cid: info,
                status: 0
            }));
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () { 
        let info = $(this).data("info")
        $.post('https://ucrp-mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".Set-Waypoint", function () { 
        const data = $(this).data("info")
		var arr = data.split(/\s+/);
        $.post('https://ucrp-mdt/setWaypoint', JSON.stringify({
            callid: arr[0],
			x: arr[1],
			y: arr[2]
        }));
    ...
    $(".contextmenu").on("click", ".call-attach", function () { 
        ...
        $.post('https://ucrp-mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () { 
        const callId = $(this).data("info")
        $.post('https://ucrp-mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () { 
        const callId = $(this).data("info")
        $.post('https://ucrp-mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://ucrp-mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://ucrp-mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () { 
        ...
        $.post('https://ucrp-mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () { 
        const cid = $(this).data("info")
        $.post('https://ucrp-mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://ucrp-mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".hirecid-buttons").on("click", ".hirecid-submit", function () {
        ...
        $.post('https://ucrp-mdt/hirecid', JSON.stringify({
            cid: hirecid
        }));
        $.post('https://ucrp-mdt/getAllStaff', JSON.stringify({}));
    ...
    $(".dismiss-buttons").on("click", ".dismiss-submit", function () {
        ...
        $.post('https://ucrp-mdt/dismissStaff', JSON.stringify({
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://ucrp-mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
        ...
        if (sentJob) {
            if (sentJob == 'police') {
                if (sentDepartment == '1') { //BCSO
                    ...
                    document.documentElement.style.setProperty('--color-9', '#273c53');
                ...
                $(".roster-iframe").attr("src", "https://docs.google.com/spreadsheets/d/1K12YWmCGyj2ZWETcJcaMOd1l5cDk7t9LpVckwHLjDA8/edit?usp=sharing")                
            } else if (sentJob == 'ems') {
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://ucrp-mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
...
function fidgetSpinner(page) {
    ...
    if (page == '.stafflogs-page-container') {
        $.post('https://ucrp-mdt/getAllLogs', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://ucrp-mdt/newTag', JSON.stringify({
...
function removeImage(url) {
    ...
    $.post('https://ucrp-mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}
...
function hideJailMenu() {
    if ($(".send-to-jail-container").css("display") != "none" && ! mouse_is_inside) {
        $(".send-to-jail-container").fadeOut(250);
        $(".close-all").css("filter", "none");
    }
}
...
function onMouseDownJail(e) {
    hideJailMenu();
    document.removeEventListener('mouseup', onMouseDownJail);
}
