RegisterNetEvent('ucrp-bikerent:menu')
AddEventHandler('ucrp-bikerent:menu', function()                           
  TriggerEvent('ucrp-context:sendMenu', {
        ...
        },
        {
			...
			params = {
                event = "ucrp-bikerent:checkmoney",
                args = {
                    car = Config.bike1,
...
RegisterNetEvent('ucrp-bikerent:checkmoney')
AddEventHandler('ucrp-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("ucrp-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('ucrp-bikerent:spawnbike')
AddEventHandler('ucrp-bikerent:spawnbike', function(vehicleName)                            
