...
AddEventHandler("ucrp-ui:voice:setvoiceRange", function(proximity)
    sendAppEvent("hud", {
...
AddEventHandler("ucrp-ui:voice:setRadioActive", function()
    sendAppEvent("hud", {
        voiceActive = false,
...
AddEventHandler("ucrp-ui:voice:setRadioActiveFinished", function()
    sendAppEvent("hud", {
        voiceActive = false,
