...
RegisterServerEvent("ucrp-signin:duty")
AddEventHandler("ucrp-signin:duty", function(pJobType, pSrc)
...
RegisterServerEvent("ucrp-signoff:duty")
AddEventHandler("ucrp-signoff:duty", function(job)
	local src = source
    if job == 'police' then
