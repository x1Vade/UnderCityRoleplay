...
Citizen.CreateThread(function()
    ...
    while(true) do
		...
		if addedPolyZone == false then
			    exports["ucrp-polyzone"]:AddBoxZone("carrent", vector3(110.4619140625, -1090.6267089844, 29.302474975586), 0.8, 0.9, {
				name="carrent",
				heading=331.47,
				debugPoly=false,
				minZ=22.37,
...
--RegisterNetEvent('ucrp-carrent:menu')
--AddEventHandler('ucrp-carrent:menu', function()   
...
RegisterNetEvent('ucrp-carrent:checkmoney')
AddEventHandler('ucrp-carrent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("ucrp-carrent:hasmoney", price, vehicle)

end)

RegisterNetEvent('ucrp-carrent:spawncar')
AddEventHandler('ucrp-carrent:spawncar', function(vehicleName)                            
