...
AddEventHandler("ucrp-jobmanager:playerBecameJob", function(job, name, notify)
   ...
   -- TriggerServerEvent("ucrp-items:updateID",job,exports["isPed"]:retreiveBusinesses())
end)

RegisterNetEvent("ucrp-base:characterLoaded")
AddEventHandler("ucrp-base:characterLoaded", function(character)
    local LocalPlayer = exports["ucrp-base"]:getModule("LocalPlayer")
    LocalPlayer:setVar("job", "unemployed")

end)

RegisterNetEvent("ucrp-base:exportsReady")
