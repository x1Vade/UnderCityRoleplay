...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("ucrp-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("ucrp-sync:clientExecuteSyncNative")
AddEventHandler("ucrp-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
