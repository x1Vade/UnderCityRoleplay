RPC.register("givePlayerJobPay",function(pSource,pInfo,pCash)
    ...
    user:addMoney(pCash.param)--- MintHavoc Change Banking
    return
end)

RPC.register("ucrp-hunting:getSettings",function()
    return Config.Hunting
end)

RPC.register("ucrp-hunting:getSkinnedItem",function(pSource,pNetId,pMySpawn,pIllegal,pAnimalName)
...
RegisterServerEvent('ucrp-hunting:skinReward')
AddEventHandler('ucrp-hunting:skinReward', function()
