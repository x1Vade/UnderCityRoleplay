...
function NPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('ucrp-base:sv:player_control_set',NPX.Controls.Current)
...
RegisterNetEvent("ucrp-base:cl:player_control")
AddEventHandler("ucrp-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('ucrp-base:setcontrols')
AddEventHandler('ucrp-base:setcontrols', function()
	TriggerServerEvent('ucrp-base:sv:player_controls')
end)
