...
RegisterNetEvent("ucrp-base:setVar")
AddEventHandler("ucrp-base:setVar", setVar)

RegisterNetEvent("ucrp-base:setChar")
AddEventHandler("ucrp-base:setChar", setChar)

RegisterNetEvent("ucrp-base:resetVars")
AddEventHandler("ucrp-base:resetVars", resetVars)
