...
function NPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        if new then TriggerEvent("ucrp-base:newCharacterSpawned") DoScreenFadeIn(500) end
...
-- RegisterNetEvent("ucrp-base:newCharacterSpawned")
-- AddEventHandler('ucrp-base:newCharacterSpawned', function()
--     DestroyAllCams(true)
--     TriggerEvent("raid_clothes:defaultReset")
--     FreezeEntityPosition(PlayerPedId(), false)
-- end)

RegisterNetEvent("ucrp-base:firstSpawn")
