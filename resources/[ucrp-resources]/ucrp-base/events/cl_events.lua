...
function NPX.Events.Trigger(self, event, args, callback)
    ...
    TriggerServerEvent("ucrp-events:listenEvent", id, event, args)
end

RegisterNetEvent("ucrp-events:listenEvent")
AddEventHandler("ucrp-events:listenEvent", function(id, data)
