...
RegisterNetEvent("ucrp-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("ucrp-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("ucrp-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("ucrp-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('ucrp-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("ucrp-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("ucrp-dirtymoney:alterDirtyMoney","ItemDrop",amount)
