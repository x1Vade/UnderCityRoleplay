...
RegisterNetEvent('ucrp-voice:syncRadioData', syncRadioData)
...
RegisterNetEvent('ucrp-voice:setTalkingOnRadio', setTalkingOnRadio)
...
RegisterNetEvent('ucrp-voice:addPlayerToRadio', addPlayerToRadio)
...
RegisterNetEvent('ucrp-voice:removePlayerFromRadio', removePlayerFromRadio)
...
function setRadioChannel(channel)
	...
	TriggerServerEvent('ucrp-voice:setPlayerRadio', channel)
...
RegisterCommand('+radiotalk', function()
    ...
    if not voiceData.radioPressed and voiceData.radioEnabled then
        if voiceData.radio > 0 then
            TriggerServerEvent('ucrp-voice:setTalkingOnRadio', true)
            voiceData.radioPressed = true
			playMicClicks(true)
            Citizen.CreateThread(function()
                TriggerEvent("ucrp-voice:radioActive", true)
...
RegisterCommand('-radiotalk', function()
	if voiceData.radio > 0 or voiceData.radioEnabled then
		...
		TriggerEvent("ucrp-voice:radioActive", false)
		playMicClicks(false)
		TriggerServerEvent('ucrp-voice:setTalkingOnRadio', false)
...
RegisterNetEvent('ucrp-voice:clSetPlayerRadio', syncRadio)
