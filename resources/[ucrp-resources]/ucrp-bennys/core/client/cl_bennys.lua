...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("ucrp-bennys:attemptPurchase",cheap, type, upgradeLevel)
...
function RepairVehicle()
    ...
    local finished = exports["ucrp-taskbar"]:taskBar(10000 + (missingBodyHealth / 50), "Repairing vehicle...", false, true)
...
function ExitBennys()
    ...
    TriggerServerEvent("ucrp-bennys:removeFromInUse", currentBennys)
    if currentBennys:find('^devbennys') then
        --
    else
        exports["ucrp-ui"]:showInteraction("Bennys")
    end
    currentBennys = nil
end
...
--#[Event Handlers]#--
RegisterNetEvent("ucrp-bennys:purchaseSuccessful")
AddEventHandler("ucrp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
end)

RegisterNetEvent("ucrp-bennys:purchaseFailed")
AddEventHandler("ucrp-bennys:purchaseFailed", function()
...
AddEventHandler("bennys:enter", function()
    ...
    --[[local isBennysInUse = RPC.execute("ucrp-bennys:checkIfUsed", currentBennys)
    ...
    ::hasAccess::
    TriggerServerEvent("ucrp-bennys:addToInUse", currentBennys)
