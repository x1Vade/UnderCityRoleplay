...
local function returnBoat()
    ...
    local finished = exports["ucrp-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("ucrp-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["ucrp-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("ucrp-fishing:rentBoat", function(name)
...
AddEventHandler("ucrp-fishing:returnBoat", function()
