...
RegisterNetEvent("ucrp-civjobs:package-chicken")
AddEventHandler("ucrp-civjobs:package-chicken", function(position)
	if exports["ucrp-inventory"]:hasEnoughOfItem("slaughteredchicken", 2) then
		...
		local finishedpacking = exports['ucrp-taskbar']:taskBar(7500, 'Putting the chicken in the box')
...
AddEventHandler("dreams-civjobs:process-alive_chicken", function(position)
	if exports["ucrp-inventory"]:hasEnoughOfItem("livechicken", 1) then
		...
		local finished = exports['ucrp-taskbar']:taskBar(10000, 'Cutting the Chicken')
...
Citizen.CreateThread(function()
	...
	Citizen.Wait(0)
		if ragdoll then
			...
			TriggerEvent('ucrp-hospital:client:ResetLimbs')
            TriggerEvent('ucrp-hospital:client:RemoveBleed')
			ragdoll = false
		end
	end
end)
...
AddEventHandler("dreams-chickens:sell", function()
	if exports["ucrp-inventory"]:hasEnoughOfItem("cbbucket",2,false) then 
		...
		local finished = exports['ucrp-taskbar']:taskBar(5000, 'Selling the chicken!')
		...
		if (finished == 100) then
			local chicken = math.random(110, 175)
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chicken_procces_station_1", vector3(-95.52, 6207.25, 31.03), 2, 1.8, {
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "dreams_chicken_procces_station_1" then
		...
		exports['ucrp-ui']:showInteraction("[E] Process Alive Chicken")
    end
end)
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chicken_procces_station_2", vector3(-100.34, 6202.42, 31.03), 1, 1.8, {
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chicken_process_1", vector3(-99.97, 6211.17, 31.03), 2, 2, {
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "dreams_chicken_process_1" then
		...
		exports['ucrp-ui']:showInteraction("[E] Process Slaughtered Chicken [Bay 1]")
    end
end)
...
function DreamsChickenProcess1()
	Citizen.CreateThread(function()
        while DreamsProcessSlaughtered1 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('ucrp-civjobs:package-chicken')
			end
		end
	end)
end
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chicken_process_2", vector3(-102.1, 6208.91, 31.03), 2, 2, {
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "dreams_chicken_process_2" then
		...
		exports['ucrp-ui']:showInteraction("[E] Process Slaughtered Chicken [Bay 2]")
    end
end)
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chicken_process_3", vector3(-104.31, 6206.7, 31.03), 2, 2, {
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "dreams_chicken_process_3" then
		...
		exports['ucrp-ui']:showInteraction("[E] Process Slaughtered Chicken [Bay 3]")
    end
end)
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chickens_start", vector3(2387.34, 5044.39, 46.31), 2, 2, {
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "dreams_chickens_start" then
		...
		exports['ucrp-ui']:showInteraction("[E] Start Catching Chickens")
    end
end)
...
Citizen.CreateThread(function()
    exports["ucrp-polyzone"]:AddBoxZone("dreams_chicken_sales", vector3(-591.81, -892.58, 25.81), 2, 2, {
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "dreams_chicken_sales" then
		...
		exports['ucrp-ui']:showInteraction("[E] Sell Packaged Chickens")
    end
end)
