...
RegisterServerEvent('ucrp-civjobs:sell-gem-cash')
AddEventHandler('ucrp-civjobs:sell-gem-cash', function()
...
RegisterServerEvent('ucrp-civjobs:sell-stone-cash')
AddEventHandler('ucrp-civjobs:sell-stone-cash', function()
    local src = tonumber(source)
    local user = exports["ucrp-base"]:getModule("Player"):GetUser(src)
...
RegisterServerEvent('ucrp-civjobs:sell-coal-cash')
AddEventHandler('ucrp-civjobs:sell-coal-cash', function()
    local src = tonumber(source)
    local user = exports["ucrp-base"]:getModule("Player"):GetUser(src)
...
RegisterServerEvent('ucrp-civjobs:sell-diamond-cash')
AddEventHandler('ucrp-civjobs:sell-diamond-cash', function()
    local src = tonumber(source)
    local user = exports["ucrp-base"]:getModule("Player"):GetUser(src)
...
RegisterServerEvent('ucrp-civjobs:sell-sapphire-cash')
AddEventHandler('ucrp-civjobs:sell-sapphire-cash', function()
    local src = tonumber(source)
    local user = exports["ucrp-base"]:getModule("Player"):GetUser(src)
...
RegisterServerEvent('ucrp-civjobs:sell-ruby-cash')
AddEventHandler('ucrp-civjobs:sell-ruby-cash', function()
    local src = tonumber(source)
    local user = exports["ucrp-base"]:getModule("Player"):GetUser(src)
