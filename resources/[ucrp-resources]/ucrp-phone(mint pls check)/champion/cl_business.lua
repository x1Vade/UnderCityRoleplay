...
RegisterNUICallback('addEmployee', function(data)
    ...
    local complete = RPC.execute('ucrp-phone:business_hired', business,cid,rankid)
...
RegisterNUICallback('editEmployee', function(data)
  ...
  local complete = RPC.execute('ucrp-phone:business_edit', business,cid,rankid)
...
RegisterNUICallback('fireEmployee', function(data)
    ...
    local complete = RPC.execute('ucrp-phone:business_fire', business,cid)
    if not complete then
