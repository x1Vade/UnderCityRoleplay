...
RegisterNUICallback("ucrp-ui:pingSend", function(data, cb)
...
RegisterNUICallback("ucrp-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("ucrp-ui:pingReject", function(data, cb)
