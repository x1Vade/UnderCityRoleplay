...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('ucrp-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("ucrp-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("ucrp-phone:getWenmo")
    local wenmo = {}
