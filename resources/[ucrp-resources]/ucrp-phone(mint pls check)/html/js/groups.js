...
function addIdleGroup(IdleGroup){
    ...
    $('.g-join').click(function(){
        ...
        $.post("https://ucrp-phone/j_group", JSON.stringify({
            gId: gid,
            members: members
        }))
...
$('.b-g-ready').click(function(){
    ...
    if (ready == 0){
        ...
        $.post("https://ucrp-phone/group_status", JSON.stringify({
            status: true,
            gId: gId
        }))
    }else{
...
$('#create-Group').click(function(){
    ...
    $.post("https://ucrp-phone/c_group", JSON.stringify({}))
    complateInputJustGreen();
        setTimeout(() => {
            // $.post("https://ucrp-phone/btnDebt", JSON.stringify({}))
...
$('.g-disband').click(function(){
    ...
    $.post("https://ucrp-phone/leave_group", JSON.stringify({
        gid: gId
    }))
    complateInputJustGreen();
        setTimeout(() => {
