...
function manageGroups(id){
    $.post('http://ucrp-phone/manageGroup', JSON.stringify({
        GroupID: id
    }));
}
...
$('#group-manage-fire-accept').click(function(e){
    ...
    setTimeout(() => {
        $.post('http://ucrp-phone/fireEmployee', JSON.stringify({
...
$("#rank-submit-input").click(function (e) {
    ...
    setTimeout(() => {
        $.post('http://ucrp-phone/addEmployee', JSON.stringify({
            business: business_id,
            rank: rank,
            state_id: state_id
        }));
...
$("#rankSet-submit-input").click(function (e) {
    ...
    // console.log("SUBMIT SHIT")
    setTimeout(() => {
        $.post('http://ucrp-phone/editEmployee', JSON.stringify({
            business: business_id,
            rank: rank,
            state_id: state_id
        }));
...
$("#paycheck-submit-input").click(function (e) {
    ...
    // console.log("SUBMIT SHIT")
    setTimeout(() => {
        $.post('http://ucrp-phone/payCheckEmployee', JSON.stringify({
            business: business_id,
            amount: amount,
            state_id: state_id
        }));
...
$("#add-cash-submit-input").click(function(e){
    ...
    $('.group-manage-add-cash').hide()
    complateInputJustGreen();
    $.post('http://ucrp-phone/addCashBank', JSON.stringify({
            bid: bId,
            amount: amount,
    }));
    setTimeout(() => {
