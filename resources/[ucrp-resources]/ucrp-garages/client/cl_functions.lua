...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['ucrp-menu']:houseGarageCoords() ~= nil and exports['ucrp-menu']:NearHouseGarage() and exports['ucrp-menu']:NearHouseGarage2() then
        HousingSpawn = exports['ucrp-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("ucrp-wheelfitment_sv:getfuckingdata",veh, plate)
