...
RegisterNUICallback("ucrp-ui:application-closed", function(data, cb)
...
RegisterNUICallback("ucrp-ui:showroomChangeCar", function(data, cb)
  if vehicle then
    DeleteEntity(vehicle)
  end
...
AddEventHandler("ucrp-showrooms:enterExperience", function()
  openShowroom("pdm")
