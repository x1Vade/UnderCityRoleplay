...
AddEventHandler("store:dosafe", function()
	...
	if exports["isPed"]:isPed("countpolice") >= 2 then
		TriggerEvent("ucrp-dispatch:storerobbery2")
...
RegisterNetEvent("ucrp-robberies:HitSafes")
AddEventHandler("ucrp-robberies:HitSafes", function()
	local storeid = isStoreRobbery()
	if storeid ~= 0 then
...
RegisterNetEvent("ucrp-robberies:HitRegister")
AddEventHandler("ucrp-robberies:HitRegister", function()
