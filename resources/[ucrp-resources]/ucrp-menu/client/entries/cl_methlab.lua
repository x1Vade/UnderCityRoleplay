...
-- AddEventHandler("ucrp-meth:showSellDrugsMenuItem", function(type, b)
...
--             icon = "#walking",
--             title = "Sell",
--             event = "ucrp-meth:cornerSellProduct",
--         },
--         isEnabled = function()
...
--             icon = "#walking",
--             title = "Corner",
--             event = "ucrp-meth:cornerStartSelling",
--         },
--         isEnabled = function()
...
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:startCooking',
-- --             title = "Start Cooking",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:startCooking",
-- --         },
-- --         isEnabled = checkObject("computer"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:adjustFridgeTemp',
-- --             title = "Adjust Temperature",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:adjustFridgeTemp",
-- --         },
-- --         isEnabled = checkObject("fridge"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:adjustSteamLevel',
-- --             title = "Adjust Levels",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:adjustSteamLevel",
-- --         },
-- --         isEnabled = checkObject("distil"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:adjustDistilSettings',
-- --             title = "Adjust Settings",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:adjustDistilSettings",
-- --         },
-- --         isEnabled = checkObject("distil"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:adjustMixerTemp',
-- --             title = "Adjust Temperature",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:adjustMixerTemp",
-- --         },
-- --         isEnabled = checkObject("mixer_temperature"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:addIngredient',
-- --             title = "Add Ingredient",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:addIngredient",
-- --         },
-- --         isEnabled = checkObject("mixer_drop"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:adjustMixerSettings',
-- --             title = "Adjust Settings",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:adjustMixerSettings",
-- --         },
-- --         isEnabled = checkObject("mixer_settings"),
-- --     },
-- --     {
-- --         data = {
-- --             id = 'ucrp-meth:pickupIngredient',
-- --             title = "Pickup",
-- --             icon = "#police-check",
-- --             event = "ucrp-meth:pickupIngredient",
-- --         },
