...
Config['CoreSettings'] = {
    ...
    ["NPBASE"] = {
        ["Name"] = "ucrp-base", -- this will be used in server side to call player module
        ["ProgressBarScriptName"] = "ucrp-taskbar", -- progress bar script name link in np_readme.md
        ["HasItem"] = "ucrp-inventory", -- Imporant [ Your normal export for checking has item, default is yourservername:inventory ] 
