...
AddEventHandler('police:tenThirteenA', function()
      ...
      recipientList = {
		...
		TriggerEvent('ucrp-alerts:1013A')
end)
...
AddEventHandler('police:tenThirteenB', function()
      ...
      recipientList = {
		...
		TriggerEvent('ucrp-alerts:1013B')
end)
...
AddEventHandler('police:panic', function()
    ...
    TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 3.0, 'polalert', 0.3)
      ...
      recipientList = {
		...
		TriggerEvent('ucrp-alerts:policepanic')
end)
...
AddEventHandler("police:tenForteenA", function()	
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('ucrp-alerts:1014A')
end)
...
AddEventHandler("police:tenForteenB", function()
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('ucrp-alerts:1014B')
end)
...
AddEventHandler("police:1047", function()
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('ucrp-alerts:downguy')
end)
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      TriggerEvent('ucrp-alerts:gunshot')
...
function AlertpersonRobbed(vehicle)
  ...
  TriggerEvent('ucrp-alerts:robstore')
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('ucrp-alerts:robhouse')
  Wait(math.random(5000,15000))
...
function DrugSales()
  ...
  TriggerEvent('ucrp-alerts:sellingdrugs')
  Wait(math.random(5000,15000))
...
function AlertBankTruck()
  ...
  TriggerEvent('ucrp-alerts:bankt')
  Wait(math.random(5000,15000))
...
function AlertJewelRob()
  ...
  TriggerEvent('ucrp-alerts:jewrob')
  Wait(math.random(5000,15000))
...
RegisterNetEvent("ucrp-dispatch:alert", function(pType)
...
function AlertFleecaRobbery()
  ...
  TriggerEvent("ucrp-dispatch:fleeca:bank", plyPos)
end
...
exports("SendAlert", function(pAlertType)
  TriggerEvent("ucrp-dispatch:alert", pAlertType)
end)


RegisterCommand("2", function(src, args, raw)
  exports['ucrp-dispatch']:SendAlert("AlertFleecaRobbery")
end)