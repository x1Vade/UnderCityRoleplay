...
RegisterNetEvent("ucrp-sceneui:open-application")
AddEventHandler("ucrp-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("ucrp-sceneui:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("ucrp-ui:soundPlay")
AddEventHandler("ucrp-ui:soundPlay", function(name, volume, loop)
