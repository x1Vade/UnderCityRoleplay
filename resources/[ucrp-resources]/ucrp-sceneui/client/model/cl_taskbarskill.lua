...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["ucrp-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['ucrp-actionbar']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['ucrp-actionbar']:disableActionBar(false)
