...
RegisterNetEvent("ucrp-slotmachines-sv:sitDownAtSlotMachine",function(slot)
    activeSlots = slot
    print(slot)
    local coinValue = 1
    TriggerClientEvent("ucrp-slotmachines-cl:sitDownAtSlotMachine",source, slot)
end)

RegisterNetEvent("ucrp-slotmachines-sv:spinMachine",function(currentSlotMachinePos,currentSlotMachineModel,currentBet,cid)
    ...
    TriggerClientEvent('ucrp-slotmachines-cl:startSpin', source, w)
end)

RegisterNetEvent('ucrp-slotmachines-sv:slotsCheckWin')
AddEventHandler('ucrp-slotmachines-sv:slotsCheckWin',function(win, dt)
	CheckForWin(win, dt)
end)
...
function CheckForWin(w, data)
    ...
    TriggerClientEvent("ucrp-slotmachines-cl:spinFinished", source, total)
end