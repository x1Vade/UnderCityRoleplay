...
Citizen.CreateThread(function()
  exports["ucrp-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('ucrp-propattach:attach')
AddEventHandler('ucrp-propattach:attach', function(pPropItem, pTargetFunction)
