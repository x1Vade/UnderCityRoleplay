...
AddEventHandler('hadcocaine', function()
  ...
  TriggerEvent("client:newStress", false, math.random(15, 25))
...
AddEventHandler('inventory:ketamine', function(pPurity)
  ...
  TriggerServerEvent("ucrp-drugeffects:forceStress", 1, 3 * 60 * 1000)
  ...
  ketaActive = false
  TriggerEvent("fx:run", "cocaine", 10, 0.0, false, false)
  TriggerServerEvent("ucrp-drugeffects:forceStress", 5000, 10 * 60 * 1000)
end)
...
AddEventHandler('hadcrack', function()
  ...
  TriggerEvent("client:newStress", true, math.random(16,20))
