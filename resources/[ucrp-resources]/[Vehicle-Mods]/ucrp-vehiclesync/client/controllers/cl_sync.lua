...
function SetEngineSound(pVehicle)
    local sound = exports['ucrp-vehicles']:GetVehicleAfterMarket(pVehicle, 'engineSound')
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('ucrp-vehicleSync:updateSyncState', netId, syncState)
    end)
end
...
RegisterNetEvent('ucrp-vehicleSync:updateSyncState')
AddEventHandler('ucrp-vehicleSync:updateSyncState', function(pNetId, pSyncState)
...
RegisterNetEvent('ucrp-vehicles:spawnedGarageVehicle')
AddEventHandler('ucrp-vehicles:spawnedGarageVehicle', function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports['ucrp-vehicles']:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)