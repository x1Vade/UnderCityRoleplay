...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('ucrp-vehicleSync:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
RegisterNetEvent('ucrp-vehicleSync:updateSirenState')
AddEventHandler('ucrp-vehicleSync:updateSirenState', function(pNetId, pSirenState, pSirenPreset)
...
Citizen.CreateThread(function()
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Lights", "+toggleSirenLights", "-toggleSirenLights", "Q")
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Sound", "+toggleSiren", "-toggleSiren", "LMENU")
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Cycle Sound", "+cycleSiren", "-cycleSiren", "R")
    exports["ucrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren AirHorn", "+sirenAirHorn", "-sirenAirHorn", "E")
end)