...
RegisterNetEvent('ucrp-rpc:cl_request')
AddEventHandler('ucrp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('ucrp-rpc:cl_response', src, origin, callId, response)
end)