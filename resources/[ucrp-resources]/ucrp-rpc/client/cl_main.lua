...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('ucrp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('ucrp-rpc:cl_response')
AddEventHandler('ucrp-rpc:cl_response', function(origin, callId, response)
