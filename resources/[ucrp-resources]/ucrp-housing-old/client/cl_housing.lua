...
Citizen.CreateThread(function()
    while true do
        ...
        if insidehouse == true then
            ...
            --         -- exports["ucrp-ui"]:showInteraction("Enter", "classic")
            ...
            elseif clothing["x"] ~= 0.0 and #(vector3(clothing["x"],clothing["y"],clothing["z"]-0.3) - plyCoords) < 1.5 then
                ...
                TriggerEvent('ucrp-clothing:OutfitsActive', true)
                    -- DrawText3Ds( clothing["x"],clothing["y"],clothing["z"] , '/outfits to change clothing' )
                exports["ucrp-ui"]:showInteraction("Outfits", "classic")
            -- else
            --         TriggerEvent('ucrp-clothing:OutfitsActive', false)
            --         exports["ucrp-ui"]:hideInteraction("classic")
            --     end
            -- end
            ...
            elseif storage["x"] ~= 0.0 and #(vector3(storage["x"],storage["y"],storage["z"]-0.3) - plyCoords) < 1.5 then
                ...
                exports["ucrp-ui"]:showInteraction("[E] Stash", "classic")
                if IsControlJustReleased(2, 38) then
...
RegisterNetEvent('ucrp-motels:RealtorPay')
AddEventHandler('ucrp-motels:RealtorPay', function(amount)
