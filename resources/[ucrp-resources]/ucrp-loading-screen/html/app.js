...
const load = Vue.createApp({
  setup () {
    ...
    //   CarouselText4: 'For additional support please join our community at discord.gg/undercityrp',
    //   CarouselSubText4: 'Photo captured by: Robinerino#1312',

      DownloadTitle: 'Downloading Files from the Server',
      DownloadDesc: "Hang in there as we start downloading all the resources you need to play Undercity RP. \n\nOnce the download is successfully completed, you will be placed on the server and this screen will disappear. Please do not log out or turn off your PC.",

      SettingsTitle: 'Settings',
      AudioTrackDesc1: 'When disabled, the music will stop.',
