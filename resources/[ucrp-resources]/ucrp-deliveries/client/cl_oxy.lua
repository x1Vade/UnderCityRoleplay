...
local OxyDropOffs = {
[1] =  { ["X"] = 2052.56, ["Y"] = 3445.74, ["Z"] = 43.88, ["H"] = 306.25, ['info'] = ' Round About Sandy End' },	
[2] =  { ["X"] = 2054.34, ["Y"] = 3391.45, ["Z"] = 45.35, ["H"] = 178.35, ['info'] = ' Round About Sandy Enterence ' },
[3] =  { ["X"] = 2357.43, ["Y"] = 3276.77, ["Z"] = 46.54, ["H"] = 143.82, ['info'] = ' Smoke Tree Road End ' },
[4] =  { ["X"] = 2337.84, ["Y"] = 3141.63, ["Z"] = 48.2, ["H"] = 117.33, ['info'] = ' Cat Claw Ave Side Street (front of warehouse) ' },
[5] =  { ["X"] = 2469.26, ["Y"] = 3435.6, ["Z"] = 49.98, ["H"] = 148.39, ['info'] = ' Sandy Shores Trails, Trailer #1 ' },
[6] =  { ["X"] = 2361.7, ["Y"] = 3350.23, ["Z"] = 46.98, ["H"] = 53.43, ['info'] = ' Sandy Shores Trails, Trailer #2 ' },
[7] =  { ["X"] = 2197.93, ["Y"] = 3695.17, ["Z"] = 37.2, ["H"] = 99.08, ['info'] = ' Sandy Shores Trails, Stright Road' },
[8] =  { ["X"] = 2113.5, ["Y"] = 3652.84, ["Z"] = 37.41, ["H"] = 105.84, ['info'] = ' Sandy Shores Trails, Bridge' },
[9] =  { ["X"] = 2006.3, ["Y"] = 3803.66, ["Z"] = 32.18, ["H"] = 1.61, ['info'] = ' Behind Gas Station' },
[10] = { ["X"] = 1947.4, ["Y"] = 3854.72, ["Z"] = 32.14, ["H"] = 352.8, ['info'] = ' Left of the Store ' },
[11] = { ["X"] = 1906.07, ["Y"] = 3940.59, ["Z"] = 32.43, ["H"] = 310.25, ['info'] = ' Side of the Street' },
[12] = { ["X"] = 1823.95, ["Y"] = 3935.55, ["Z"] = 33.34, ["H"] = 54.26, ['info'] = ' Side of the Wanky Trailer  ' },
[13] = { ["X"] = 1823.83, ["Y"] = 3889.69, ["Z"] = 33.59, ["H"] = 197.71, ['info'] = ' In front of Trailer with Bullet Holes  ' },
[14] = { ["X"] = 1801.24, ["Y"] = 3810.71, ["Z"] = 33.57, ["H"] = 281.59, ['info'] = ' In front of 2 Satalites ' },
[15] = { ["X"] = 1732.16, ["Y"] = 3764.71, ["Z"] = 33.79, ["H"] = 263.38, ['info'] = ' Palm Trees left of Ammo in Sandy ' },
}
...
local pillWorker = { ["x"] = 1436.23, ["y"] = 3638.99, ["z"] = 34.95, ["h"] = 203.54, ['info'] = 'boop bap' }
...
local carspawns = {
	[1] =  { ["X"] = 1451.43, ["Y"] = 3640.85, ["Z"] = 34.65, ["H"] = 327.84, ' car 1' },
	[2] =  { ["X"] = 1454.0, ["Y"] = 3636.15, ["Z"] = 34.69, ["H"] = 332.0, ' car 3' },
	[3] =  { ["X"] = 1455.52, ["Y"] = 3628.6, ["Z"] = 34.78, ["H"] = 316.1, ' car 2' },
	[4] =  { ["X"] = 1465.53, ["Y"] = 3658.35, ["Z"] = 34.45, ["H"] = 134.47, ' car 5' },
	[5] =  { ["X"] = 1462.02, ["Y"] = 3664.85, ["Z"] = 34.28, ["H"] = 137.3, ' car 7' },
	[6] =  { ["X"] = 1466.92, ["Y"] = 3651.43, ["Z"] = 34.59, ["H"] = 136.93, ' car 6' },
	[7] =  { ["X"] = 1424.02, ["Y"] = 3625.39, ["Z"] = 34.86, ["H"] = 190.0, ' car 10' },
	[8] =  { ["X"] = 1420.03, ["Y"] = 3623.6, ["Z"] = 34.86, ["H"] = 136.93,  ' car 9' },
	[9] =  { ["X"] = 1415.85, ["Y"] = 3623.68, ["Z"] = 34.85, ["H"] = 204.93,  ' car 4' },
	[10] = { ["X"] = 1438.74, ["Y"] = 3617.75, ["Z"] = 34.94, ["H"] = 188.29, ' car 8' },
	[11] = { ["X"] = 1433.61, ["Y"] = 3616.97, ["Z"] = 34.95, ["H"] = 200.75,  ' car 7' },
...
AddEventHandler("oxydelivery:client", function()
	...
	while tasking do
		...
		if dstcheck < 2.0 and pedCreated then
            exports["ucrp-ui"]:showInteraction("[E] Drop off")
...
Citizen.CreateThread(function()
	exports["ucrp-polyzone"]:AddBoxZone("oxy_run_start", vector3(1436.24, 3639.09, 34.95), 3.8, 2, {
		name="oxy_run_start",
		heading=202.6,
		minZ=33.95,
		maxZ=35.95
...
AddEventHandler('ucrp-polyzone:enter', function(name)
    if name == "oxy_run_start" then
        ...
        LuckyDrawPlace()
		if not OxyRun then
			exports['ucrp-ui']:showInteraction('[E] Start Run 500$')
		else
			exports['ucrp-ui']:hideInteraction()
		end
    end
...
function DoDropOff(requestMoney)
	...
	if DoesEntityExist(deliveryPed) and not IsEntityDead(deliveryPed) then
			...
			if OxyRun then
				...
				if exports["ucrp-inventory"]:hasEnoughOfItem("rollcash",rollcount) then     
				...
				elseif exports["ucrp-inventory"]:hasEnoughOfItem("band",bandcount) then     
				...
				elseif exports["ucrp-inventory"]:hasEnoughOfItem("markedbills",markedbillsamount) then     
	...
	if success then
		...
		TriggerEvent("client:newStress",true,math.ranom(7,10))
	...
	if success then
		Citizen.Wait(2000)
		TriggerEvent("phone:addnotification", "EMAIL ", "Nice dropoff, Getting another deal setup for you GOOD SHIT! .")
	else
		TriggerEvent("DoLongHudText","The drop off failed - you need stolen items. IDIOT!",2)
	end
...
AddEventHandler('onResourceStart', function(resourceName)
	...
	print('Oxy Runs | Succesfuly Loaded Get to Delivering the drugs!')
	end)
