    ...
    data = {
        {
            ...
            label = "Weights",
            icon = "circle",
            event = "ucrp-healthcare:exercise",
            parameters = {}
        }
    },
    options = {
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "ucrp-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "ucrp-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "ucrp-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
