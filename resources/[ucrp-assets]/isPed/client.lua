...
AddEventHandler("ucrp-jobmanager:playerBecameJob", function(jobpassed, name, notify)
	job = jobpassed
    if not job then
        job = "None"
    end
...
RegisterNetEvent('ucrp-base:addedMoney')
AddEventHandler('ucrp-base:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('ucrp-base:removedMoney')
AddEventHandler('ucrp-base:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
